...
public class SocialSecurityAuthActivity extends BaseActivity implements View.OnClickListener,AddressDialogFragment.OnCitySelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_social_security_auth);
    ...
    private void initView() {
        ...
        viewList.add(getLayoutInflater().inflate(R.layout.social_security_auth_choice_one_layout,null));
        viewList.add(getLayoutInflater().inflate(R.layout.social_security_auth_choice_two_layout, null));
        ...
        examSS = (ImageView)viewList.get(1).findViewById(R.id.exam_ss);
        examSS.setOnClickListener(new ExamOnClickListener());
...
//        getMenuInflater().inflate(R.menu.menu_social_security_auth, menu);
//        return true;
//    }
//
//    @Override
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.submit_one:
                ...
                if (cityId == 0) {
                    Toast.makeText(this,getString(R.string.social_security_auth_city_select_errors),Toast.LENGTH_LONG).show();
                    return;
                }
                if (selfPayAmount_i == 0) {
                    Toast.makeText(this,getString(R.string.social_security_auth_self_pay_amount_errors),Toast.LENGTH_LONG).show();
                    return;
                }
                if (account_s.equals("")) {
                    account.requestFocus();
                    account.setError(getString(R.string.social_security_auth_account_errors));
                    return;
                } else if (password_s.equals("")) {
                    password.requestFocus();
                    password.setError(getString(R.string.social_security_auth_password_errors));
                    return;
                }
                ...
                bundle.putInt(Constants.INFO_SUBMIT, Constants.SOCIAL_SECURITY_SUBMIT);
...
//                        break;
                ...
                if(PreferenceUtils.getFourStatus()==0){
                    PreferenceUtils.setFourStatus(1);
                }
                postParameters.add(new BasicNameValuePair("api", "authSocialSecurityApi"));
    ...
    public class ExamOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(SocialSecurityAuthActivity.this, ViewPagerExampleActivity.class);
            int pos = 0;
            intent.putStringArrayListExtra("imgs", new ArrayList<String>(Arrays.asList(new String[]{"ss_ex"})));
            ...
            ArrayList<Integer> list = new ArrayList<>(Arrays.asList(new Integer[]{R.drawable.exam_ss}));
    ...
    public void echoHistory() {
        ...
        pullParameters.add(new BasicNameValuePair("api", "authSocialSecurityApi"));
        pullParameters.add(new BasicNameValuePair("query", "1"));
        HttpAsyncTask.getInstance(this,PreferenceUtils.getUserId()+"",pullParameters).pullSocialSecurityInfo();
