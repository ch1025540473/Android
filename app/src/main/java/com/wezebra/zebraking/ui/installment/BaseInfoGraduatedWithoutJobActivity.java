...
public class BaseInfoGraduatedWithoutJobActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Spinner sourceOfLive,expend,marriage;
    private EditText creditAmount;

    private ProgressBarHolder progressBarHolder;

    private int sourceOfLive_i,expend_i,marriage_i,creditCard_i,overdue_i;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_base_info_graduated_without_job);
    ...
    private void showProgressbar() {
        ...
        Animation animation = AnimationUtils.loadAnimation(this, R.anim.anim_base_info_progressbar_g_uj);
        ...
        observer.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                ValueAnimator animator = new ObjectAnimator().ofInt(progressBarHolder, "progress", 50, 100).setDuration(1000);
    ...
    private void initView() {
        ...
        //Init Spinner
        sourceOfLive = (Spinner)findViewById(R.id.source_of_live);
        expend = (Spinner)findViewById(R.id.expend);
        marriage = (Spinner)findViewById(R.id.marriage);
        SpinnerUtils.initSourceOfIncome(this, sourceOfLive);
...
//        getMenuInflater().inflate(R.menu.menu_base_info_graduated_step_two, menu);
//        return true;
//    }
//
//    @Override
                ...
                if (inputCheck()) {
                    ...
                    builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            HttpAsyncTask httpAsyncTask = HttpAsyncTask.getInstance(BaseInfoGraduatedWithoutJobActivity.this, PreferenceUtils.getUserId()+"", postParameters);
...
//                }
    ...
    public boolean inputCheck() {
        ...
        switch (sourceOfLive.getSelectedItemPosition()) {
            case 0:
                Toast.makeText(this,getString(R.string.source_of_life_errors),Toast.LENGTH_LONG).show();
                return false;
            default:
                sourceOfLive_i = sourceOfLive.getSelectedItemPosition();
                postParameters.add(new BasicNameValuePair("lifeType", sourceOfLive_i +""));
                break;
        }
    ...
    public void echoHistory() {
        ...
        sourceOfLive.setSelection(user.getLifeType());
