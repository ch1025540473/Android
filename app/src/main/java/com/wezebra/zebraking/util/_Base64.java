...
/**
 * 是一个标准的Base64编码和转换的工具，为了迎合js的需要， 故在此重复工作；当然，我们可以使用JDK API
 * 自带的BASE64Decoder和BASE64Encoder 进行编码和解码，但是就不能随意调整Base64的主要参数。
 * 
 * @author dongping
 * @date May 2, 2010
 */
public class _Base64 {
	...
	private static final ThreadLocal<_Base64> base64Instance = new ThreadLocal<_Base64>();
