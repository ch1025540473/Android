 ...
 */
public class PhotoUploadComponent2 {
    ...
    public PhotoUploadComponent2(int count, LinearLayout add_one_more, FrameLayout[] upload_layout, ImageView[] photo_img) {
        this.count = count;
    ...
    public PhotoUploadComponent2() {

    }

    public PhotoUploadComponent2 clone() {

        PhotoUploadComponent2 photoUploadComponent = new PhotoUploadComponent2();
