...
public class LockPatternActivity extends ActionBarActivity
{
    ...
    public static final int RESULT_OTHER_ACCOUNT_PATTERN = RESULT_FIRST_USER + 3;
...
//    }// onKeyDown()
    ...
    private void initContentView()
    {
        ...
        mForgetLayout = findViewById(R.id.forget_password_layout);
        ...
        mBtnForget = (Button) findViewById(R.id.forget_password);
        mBtnOther = (Button) findViewById(R.id.other_account);
        mBtnForget.setOnClickListener(mForgetBtnOnclickListener);
        mBtnOther.setOnClickListener(mOtherAccountBtnOnclickListener);
...
//            mBtnCancel.setVisibility(View.VISIBLE);
            ...
            getSupportActionBar().setTitle("选择您的图案");
        ...
        {
            getSupportActionBar().setTitle("确认您的图案");
...
//                    simulateBtnConfirmClick();
    ...
    private View.OnClickListener mForgetBtnOnclickListener = new View.OnClickListener()
    {
        @Override
        public void onClick(View v)
        {
    ...
    private View.OnClickListener mOtherAccountBtnOnclickListener = new View.OnClickListener()
    {
        @Override
        public void onClick(View v)
        {
            finishWithNegativeResult(RESULT_OTHER_ACCOUNT_PATTERN);
        }
    };


    private void simulateBtnConfirmClick()
    {
        if (ACTION_CREATE_PATTERN.equals(getIntent().getAction()))
        {
            if (mBtnOkCmd == ButtonOkCommand.CONTINUE)
